...
<p align="center" class="style3">&nbsp;</p>
<form action="queryUser" method="post" name="form1" id="form1">
  <p align="center" class="style1">★ <a href="viewAllusers"> 查看所有注册用户</a></p>
  <p align="center" class="style1">★ <span class="style4">按用户号进行查找：</span>  
    <input name="queryId" type="text" id="category">
    <input type="submit" name="Submit" value="查找">
</p>
</form>
<form action="queryUser" method="post" name="form2" id="form2">
<div align="center">
