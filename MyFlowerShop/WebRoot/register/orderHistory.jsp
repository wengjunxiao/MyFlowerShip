...
border=0>
  <form action="cart.jsp" method=get>
    <tbody>
      ...
      <tr bgcolor=#FFFFFF>
        <td colspan="2"><div align=center>${myOrder.ordersId}</div></td>
        <td><div align=center>${myOrder.ordersPrice}</div></td>
        <td><div align=center>${myOrder.ordersDatetime}</div></td>
        <td><div align=center><a href='orderDetail?ordersId=${myOrder.ordersId}' class="style5">点此查看</a></div></td>
      </tr>
      </c:forEach>
      <tr bgcolor=#ffffff>
